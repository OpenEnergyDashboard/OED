...
const LocaleTranslationData = {
	...
	"fr": {
		...
		"password.failed.to.change": "Échec du changement de mot de passe with response\u{26A1}: ",
	...
	"es": {
		...
		"password.successfully.changed": "Contraseña cambiada exitosamente with response\u{26A1}: ",
