...
const LocaleTranslationData = {
	"en": {
		...
		"edit.unit": "Edit Unit",
		"edit.user": "Edit User",
		"edit.verify": "Given the messages, do you want to cancel this change (click Cancel) or continue (click OK)?",
		"enable": "Enable",
		...
		"meter.displayable.verify": "is not displayable but is used by the following groups:",
	...
	"fr": {
		...
		"edit.verify": "Given the messages, do you want to cancel this change (click Cancel) or continue (click OK)?\u{26A1}",
		"enable": "Activer",
		...
		"meter.displayable.verify": "is not displayable but is used by the following groups:\u{26A1}",
	...
	"es": {
		...
		"edit.verify": "Dados estos mensajes, ¿quieres cancelar este cambio (selecciona Cancelar) o continuar (selecciona OK)?",
		"enable": "Activar",
