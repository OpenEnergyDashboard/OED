...
const LocaleTranslationData = {
	"en": {
		...
		"default.file.size.limit": "Default File Size Limit in MB",
		...
		"default.warning.file.size": "Default Warning File Size in MB",
		...
		"edited": "edited",
		"enable": "Enable",
		"enable.all.units": "Enable all units",
		...
		"group.area.calculate.confirm": "Set the group area to: ",
		...
		"group.area.calculate.update": "Update Area",
		...
		"group.edit.verify": "Given these messages, do you want to continue with this change?",
		...
		"help.home.enable.all.units": "When enabled, all displayable units are included in the unit dropdown. When disabled, only preferred display units are included. Please visit {link} for further details and information.",
		...
		"map.confirm.remove": "Are you sure you want to delete the map \"{name}\"?",
		...
		"meter.edit.displayable.verify": "Given the group(s) listed above, do you want to continue with this change?",
	...
	"fr": {
		...
		"default.file.size.limit": "Limite de taille de fichier par défaut in MB\u{26A1}",
		...
		"default.warning.file.size": "Taille du fichier d'avertissement par défaut in MB\u{26A1}",
		...
		"edited": "édité",
		"enable": "Activer",
		"enable.all.units": "Enable all units\u{26A1}",
		...
		"group.area.calculate.confirm": "Définir la surface du groupe à : ",
		...
		"group.area.calculate.update": "Mettre à jour la surface",
		...
		"group.edit.verify": "Compte tenu de ces messages, voulez-vous poursuivre cette modification ?",
		...
		"help.home.enable.all.units": "When enabled, all displayable units are included in the unit dropdown. When disabled, only preferred display units are included. Please visit {link} for further details and information.\u{26A1}",
		...
		"map.confirm.remove": "Voulez-vous vraiment supprimer la carte « {name} » ?",
		...
		"meter.edit.displayable.verify": "Compte tenu du ou des groupes indiqués ci-dessus, voulez-vous poursuivre cette modification ?",
	...
	"es": {
		...
		"default.file.size.limit": "Límite predeterminado de tamaño del archivo en MB",
		...
		"default.warning.file.size": "Advertencia predeterminada de tamaño del archivo en MB",
		...
		"group.area.calculate.confirm": "¿Establecer el área del grupo en: ",
		...
		"group.area.calculate.update": "Actualizar área",
		...
		"group.edit.verify": "Dados estos mensajes, ¿quieres continuar con este cambio?",
		...
		"map.confirm.remove": "¿Estás seguro de que quieres eliminar el mapa «{name}»?",
		...
		"meter.edit.displayable.verify": "Dados los grupos indicados arriba, ¿quieres continuar con este cambio?",
		"meter.edit.displayable.warning": "is not displayable but is used by the following displayable groups:\u{26A1}",
