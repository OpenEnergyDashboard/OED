...
const LocaleTranslationData = {
	...
	"es": {
		...
		"help.csv.meters": "Esta página permite a los administradores cargar medidores a través de un archivo CSV. Visite {enlace} para obtener más detalles e información.\u{26A1}",
