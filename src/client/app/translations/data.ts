...
const LocaleTranslationData = {
	...
	"fr": {
		...
		"conversion.delete.suffix.dependencies.warning": "Warning: Some meters or groups depend on units that will be affected.\u{26A1}",
		"conversion.delete.suffix.disable": "Deleting this suffix conversion will disable use of suffix.\u{26A1}",
		"conversion.delete.suffix.groups.affected": "Affected groups\u{26A1}",
		"conversion.delete.suffix.meters.affected": "Affected meters\u{26A1}",
