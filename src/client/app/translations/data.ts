...
const LocaleTranslationData = {
	"en": {
		...
		"calibration.save.database": "Save changes to finalize",
		"calibration.submit.button": "Submit GPS point",
		"cancel": "Cancel",
		...
		"failed.to.edit.map": "Failed to edit map with error: ",
		...
		"help.admin.mapedit": "This page allows admins to edit maps. Please visit {link} for further details and information.",
		...
		"input.gps.coords.second": "Use format: latitude,longitude. Then click ",
		...
		"manage": "Manage",
		"map": "Map",
		"map.bad.360": "Greater than 360, please change angle to a number between 0 and 360",
		"map.bad.0": "Less than 0, please change angle to a number between 0 and 360",
		...
		"map.confirm.remove": "Delete map",
		"map.filename": "File: ",
		"map.flow.label": " * time / day ≡ quantity / day",
		"map.id": "Map ID",
		"map.image": "Choose file for map image (.png or .jpg)",
		...
		"map.name": "Map Name",
		"map.negative.positive.sizes": "There are negative and positive values and this impacts relative circle size.",
		"map.negative.sizes": "All values are negative so the circle sizes act as if value range was positive which may change the relative sizes.",
		"map.zero.sizes": "Some values are close to zero so the small circle sizes may be a little larger to be visible",
		"map.need.click.point": "Click image above to select a point before submitting GPS coordinates.",
		"map.new.angle": "Input angle with respect to true north (0 to 360)",
		"map.new.name": "Input a name for the map",
		"map.new.submit": "Submit and continue",
		"map.new.upload": "Upload map image to begin",
		"map.no.gps": "No point clicked on image so cannot submit.",
		"map.no.save": "Cannot save with error of: ",
		"map.notify.calibration.needed": "Calibration needed before display",
		"map.unavailable": "There's not an available map",
		"map.unacceptable.condition": "Unacceptable condition: readingsData.readings is undefined.",
		...
		"need.more.points": " more points needed",
		"no": "no",
	...
	"fr": {
		...
		"bar.label": " * time ≡ quantity\u{26A1}",
		...
		"calibration.save.database": "Enregistrer les modifications to finalize\u{26A1}",
		"calibration.submit.button": "Soumettre GPS point\u{26A1}",
		"cancel": "Annuler",
		...
		"failed.to.edit.map": "Échec de la modification d'une carte with error: \u{26A1}",
		...
		"help.admin.mapedit": "This page allows admins to edit maps. Please visit {link} for further details and information.\u{26A1}",
		...
		"input.gps.coords.second": "Use format: latitude,longitude. Then click \u{26A1}",
		...
		"map": "Carte",
		"map.bad.360": "Supérieur à 360, veuillez changer l'angle en un nombre compris entre 0 et 360",
		"map.bad.0": "Moins de 0, veuillez changer l'angle en un nombre compris entre 0 et 360",
		...
		"map.confirm.remove": "Delete map\u{26A1}",
		"map.filename": "Fichier: ",
		"map.flow.label": " * time / day ≡ quantity / day\u{26A1}",
		"map.id": "ID de la carte",
		"map.image": "Choose file for map image (.png or .jpg)\u{26A1}",
		...
		"map.negative.positive.sizes": "There are negative and positive values and this impacts relative circle size.\u{26A1}",
		"map.negative.sizes": "All values are negative so the circle sizes act as if value range was positive which may change the relative sizes.\u{26A1}",
		"map.zero.sizes": "Some values are close to zero so the small circle sizes may be a little larger to be visible\u{26A1}",
		"map.need.click.point": "Click image above to select a point before submitting GPS coordinates.\u{26A1}",
		"map.new.angle": "Input\u{26A1} l'angle par rapport au vrai nord (0 à 360)",
		"map.new.name": "Input\u{26A1} un nom pour la carte",
		"map.new.submit": "Submit\u{26A1} et continuer",
		"map.new.upload": "Téléchargez l'image de la carte pour commencer",
		"map.no.gps": "No point clicked on image so cannot submit.\u{26A1}",
		"map.no.save": "Cannot save with error of: \u{26A1}",
		"map.notify.calibration.needed": "Étalonnage nécessaire pour l'affichage",
		"map.unavailable": "There's not an available map\u{26A1}",
		"map.unacceptable.condition": "Unacceptable condition: readingsData.readings is undefined.\u{26A1}",
		...
		"name": "Nom:",
		"navigation": "Navigation",
		"need.more.points": " more points needed\u{26A1}",
		"no": "no\u{26A1}",
		"no.data.in.range": "No Data In Date Range\u{26A1}",
		"no.data.to.display": "no data to display\u{26A1}",
		...
		"threeD.time": "Temps",
		"threeD.x.axis.label": "Hours of Day\u{26A1}",
		"threeD.y.axis.label": "Days of Calendar Year\u{26A1}",
	...
	"es": {
		...
		"calibration.save.database": "Guardar los cambios en finalize\u{26A1}",
		"calibration.submit.button": "Enviar GPS point\u{26A1}",
		"cancel": "Cancelar",
		...
		"failed.to.edit.map": "No se pudo editar el mapa with error: \u{26A1}",
		...
		"input.gps.coords.second": "Use forma: latitud, longitud. Duspues selecciona ",
		...
		"manage": "Gestionar",
		"map": "Mapa",
		"map.bad.360": "Mayor a 360, por favor cambiar el angúlo a un número entre 0 a 360",
		"map.bad.0": "Menor a 0, por favor cambiar el angúlo a un número entre 0 a 360",
		...
		"map.zero.sizes": "Some values are close to zero so the small circle sizes may be a little larger to be visible\u{26A1}",
		"map.need.click.point": "Click image above to select a point before submitting GPS coordinates.\u{26A1}",
		"map.new.angle": " Input\u{26A1} el ángulo con respecto al norte verdadero (0 a 360)",
		"map.new.name": "Input\u{26A1} un nombre para el mapa:",
		"map.new.submit": "Submit\u{26A1} y continuar",
