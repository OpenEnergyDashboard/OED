...
const LocaleTranslationData = {
	"en": {
		...
		"holiday.day.pattern": "Day pattern",
		"holiday.day.pattern.select": "Select a day pattern when holiday rates apply",
		"holiday.edit.holiday": "Edit Holiday",
		"holiday.end.date": "End Date",
		"holiday.name": "Holiday Name",
		"holiday.name.required": "Holiday name is required",
		"holiday.rates": "Holiday Rates",
		"holiday.region": "Region",
		"holiday.start.date": "Start Date",
		"holiday.start.date.required": "Start date is required",
	...
	"fr": {
		...
		"holiday.day.pattern": "Modèle de jour",
		"holiday.day.pattern.select": "Sélectionnez un modèle de jour lorsque les tarifs de jour férié s'appliquent",
		"holiday.edit.holiday": "Modifier le jour férié",
		"holiday.end.date": "Date de fin",
		"holiday.name": "Nom du jour férié",
		"holiday.name.required": "Le nom du jour férié est requis",
		"holiday.rates": "Tarifs des jours fériés",
		"holiday.region": "Région",
		"holiday.start.date": "Date de début",
		"holiday.start.date.required": "La date de début est requise",
	...
	"es": {
		...
		"holiday.day.pattern": "Patrón de día",
		"holiday.day.pattern.select": "Seleccione un patrón de día cuando se apliquen las tarifas de días festivos",
		"holiday.edit.holiday": "Editar día festivo",
		"holiday.end.date": "Fecha de finalización",
		"holiday.name": "Nombre del día festivo",
		"holiday.name.required": "El nombre del día festivo es obligatorio",
		"holiday.rates": "Tarifas de días festivos",
		"holiday.region": "Región",
		"holiday.start.date": "Fecha de inicio",
		"holiday.start.date.required": "La fecha de inicio es obligatoria",
