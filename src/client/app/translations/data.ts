...
const LocaleTranslationData = {
	"en": {
		...
		"chart.link.options.title": "Chart Link Options:",
		...
		"help.home.toggle.chart.link.keep.current": "With the \"Keep current\" option, the chart link will always show the same span of time as the original graphic, but shifted so it ends at the current time when the link is used. This is only available if the server data range goes up to the present (unbounded on the right). The link will work for any supported graphic type (line or bar) and ensures viewers always see the most recent data for that time span. Please visit {link} for further details and information.",
		...
		"hide.options.when.using.this.label": "Hide options when using this link",
		"home": "Home",
		"hour": "Hour",
		...
		"keep.chart.current.label": "Keep chart current",
		"language": "Language",
	...
	"es": {
		...
		"chart.link.options.title": "Opciones de enlace de gráfico:",
		...
		"hide.options.when.using.this.label": "Ocultar opciones al usar este enlace",
		"home": "Inicio",
		"hour": "Hora",
		...
		"keep.chart.current.label": "Mantener el gráfico actualizado",
		"language": "Idioma",
