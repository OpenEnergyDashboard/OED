...
const LocaleTranslationData = {
	"en": {
		...
		"threeD.date": "Date",
		"threeD.date.range.exceeds.max": "3D date range exceeds maximum allowed days. Please reduce the date range or numDays setting.",
		"threeD.date.range.too.long": 'Date Range Must be a year or less',
		"threeD.incompatible": "Not Compatible with 3D",
		"threeD.numDays": "3D Date Range Span",
	...
	"fr": {
		...
		"threeD.date": "Date",
		"threeD.date.range.exceeds.max": "La plage de dates 3D dépasse le nombre maximum de jours autorisés. Veuillez réduire la plage de dates ou le paramètre numDays.",
		"threeD.date.range.too.long": "Date Range Must be a year or less\u{26A1}",
		"threeD.incompatible": "Not Compatible with 3D\u{26A1}",
		"threeD.numDays": "Plage de dates 3D",
		"threeD.time": "Temps",
		"2.years": "2 ans\u{26A1}",
		"3.years": "3 ans\u{26A1}",
		"6.months": "6 mois\u{26A1}",
	...
	"es": {
		...
		"threeD.date": "Fecha",
		"threeD.date.range.exceeds.max": "El rango de fechas 3D excede el número máximo de días permitidos. Por favor, reduzca el rango de fechas o la configuración numDays.",
		"threeD.date.range.too.long": 'El rango de datos debe ser un año o menos',
		"threeD.incompatible": "No es compatible con 3D",
		"threeD.numDays": "Rango de fechas 3D",
