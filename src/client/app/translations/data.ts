...
const LocaleTranslationData = {
	"en": {
		...
		"csv.file": "CSV File:",
		"csv.file.error": "File must be in CSV format. ",
		...
		"csv.readings.param.length.gap": "Length Gap:",
		...
		"csv.readings.param.refresh.hourly.readings": "Refresh Hourly Readings",
		...
		"help.csv.meters": "This page allows certain users to upload meters via a CSV file. Please visit {link} for further details and information.",
	...
	"fr": {
		...
		"csv.file.error": "Le fichier doit être au format CSV. ",
		...
		"csv.readings.param.length.gap": "Écart de longueur:",
		...
		"csv.readings.param.refresh.hourly.readings": "Actualiser les relevés horaires",
		...
		"help.csv.meters": "Cette page permet à certains utilisateurs de télécharger des compteurs via un fichier CSV. Veuillez visiter {link} pour plus de détails et d'informations.\u{26A1}",
	...
	"es": {
		...
		"csv.file.error": "El archivo debe estar en formato CSV. ",
		...
		"csv.readings.param.length.gap": "Espacio de largo:",
		...
		"csv.readings.param.refresh.hourly.readings": "Actualizar lecturas por hora:",
		...
		"csv.upload.meters": "Cargar Medidores",
		"csv.upload.readings": "Cargar Lecturas",
		"custom.value": "Custom value\u{26A1}",
		...
		"help.csv.meters": "Esta página permite a ciertos usuarios cargar medidores a través de un archivo CSV. Visite {link} para obtener más detalles e información.\u{26A1}",
		"help.csv.readings": "Esta página permite a ciertos usuarios cargar lecturas a través de un archivo CSV. Visite {link} para obtener más detalles e información.\u{26A1}",
		...
		"help.home.bar.days.tip": "Permite al usuario seleccionar el número de días deseado para cada barra.  Por favor, vea {link} para más detalles e información.",
