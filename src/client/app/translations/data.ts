...
const LocaleTranslationData = {
	"en": {
		...
		"meter.edit.displayable.warning": "is not displayable but is used by the following groups:",
	...
	"fr": {
		...
		"meter.edit.displayable.warning": "is not displayable but is used by the following groups:\u{26A1}",
