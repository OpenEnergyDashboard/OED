...
const localeData = {
	...
	"es": {
		...
		"bar.raw": "No puede crear un gráfico de barras con unidades crudas como temperatura",
		...
		"close": "Cerrar",
		"compare": "Comparar",
		"compare.raw": "No puede crear gráfico de comparación con unidades crudas como temperatura",
		...
		"conversion.create.exists.inverse": "Esta conversión ya existe en el que una no es bidireccional",
		...
		"conversion.failed.to.create.conversion": "No pudo crear la conversión.",
		"conversion.failed.to.delete.conversion": "No pudo eliminar la conversión",
		"conversion.failed.to.edit.conversion": "No puedo editar la conversión",
		...
		"create.unit": "Crear una unidad (Create a Unit)",
		...
		"DisplayableType.none": "nada (none)",
		"DisplayableType.all": "todo (all)",
		"DisplayableType.admin": "administrador (admin)",
		"error.bounds": "Debe ser entre {min} y {max}. (Must be between {min} and {max}.)",
		...
		"edit.unit": "Editar unidad (Edit unit)",
		...
		"group.area.calculate": "Calcular Área del Grupo (Calculate Group Area)",
		...
		"groups": "Grupos",
		"group.successfully.create.group": "Grupo creado con éxito. (Successfully created a group).",
		"group.successfully.edited.group": "Grupo editado con éxito. (Successfully edited group.)",
