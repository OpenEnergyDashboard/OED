...
const localeData = {
	"en": {
		...
		"permissionError": "Sorry you don't have permissions to download due to large number of points.",
	...
	"fr": {
		...
		"permissionError": "Désolé, vous n'avez pas les autorisations de téléchargement en raison d'un grand nombre de points.",
	...
	"es": {
		...
		"permissionError": "Lo sentimos, no tiene permisos para descargar debido a la gran cantidad de puntos.",
