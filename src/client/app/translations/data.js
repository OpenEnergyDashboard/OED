...
const localeData = {
	...
	"es": {
		...
		"default.area.normalize": "Normalizar lecturas de área por defecto",
		"default.area.unit": "Unidad de Área por Defecto",
		"default.bar.stacking": "Amontar barras por defecto",
		"default.graph.type": "Tipo de gráfico por defecto",
		"default.graph.settings": "Configuraciones del gráfico por defecto",
		"defaultGraphicUnit": "Unidad del gráfico por defecto:",
		"default.language": "Idioma por defecto",
		"default.meter.reading.frequency": "Frecuencia de la lectura del medidor por defecto",
		...
		"default.time.zone": "Zona del horario por defecto",
		...
		"group.area.calculate.error.zero": " : área no está establecido o cero",
		"group.area.calculate.error.unit": "(Need Spanish) : área distinta de cero sin unidad de área",
		...
		"help.home.navigation": "(Need Spanish) El botón \"Gráfico\" va a la página gráfica, el desplegable \"Páginas\" permite navigación a las páginas de información, el desplegable \"Opciones\" permite selección de idioma, opciones de ocultar y iniciar/cerrar sesión y el botón \"Ayuda\" va a las páginas de ayuda. Buscar ayuda en los menús desplegables o las páginas vínculadas para más informacións.",
		...
		"meter.input.error": "(Need Spanish) Entrada no válida entonces medidor no se creó ni se editó.",
		...
		"radar.no.data": "(need Spanish) No hay lecturas:<br>probablemente el rango de los datos esté fuera del rango de lecturas de los medidores/grupos",
		"rate": "Tasa",
		"reading": "Lecturas:",
		...
		"unit.sec.in.rate": "Segundo en (Need Spanish) Sec in Rate:",
