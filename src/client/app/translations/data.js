...
const localeData = {
	"en": {
		...
		"csv.download.size.warning.size": "File(s) size will be about",
	...
	"fr": {
		...
		"csv.download.size.warning.size": "(Need French) File(s) size will be about",
	...
	"es": {
		...
		"csv.download.size.warning.size": "(Need Spanish) File(s) size will be about",
