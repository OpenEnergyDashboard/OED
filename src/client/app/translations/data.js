...
const localeData = {
	"en": {
		...
		"conversions.title.main": "Conversions",
		"conversion.source" : "Source ID",
		"conversion.destination": "Destination ID",
		"conversion.bidirectional": "Bidirectional",
		"conversion.slope": "Slope",
		"conversion.intercept": "Intercept",
		"conversion.note": "Note",
		"conversion.edit": "Edit Conversion",
		"conversion.create.button": "Create Conversion",
		"conversion.edit.title": "Edit Conversion",
		"conversion.close": "Close",
		"conversion.submit": "Submit",
		"conversion.delete": "Delete",
		"conversion.create.title": "Create New Conversion",
		"conversion.submit.new": "Create Conversion",
		"conversion.failed.to.create.conversion": "Failed to create Conversion",
		"conversion.failed.to.edit.conversion": "Failed to edit Conversion",
		"conversion.is.deleted": "Conversion deleted",
		"conversion.failed.to.delete": "Failed to delete Conversion",
		"conversion.is.created": "Conversion created",
		"conversion.failed.to.create": "Failed to create Conversion",
		...
		"has.used": "Has used",
		"help.admin.conversions": "This page allows admins to view and edit conversions. Please visit {link} for further details and information.",
		"help.conversions.conversionview": "This page shows information on conversions. Please visit {link} for further details and information.",
	...
	"fr": {
		...
		"conversions.title.main": "(NEED FRENCH)Conversions",
		"conversion.source" : "(NEED FRENCH)Source ID",
		"conversion.destination": "(NEED FRENCH)Destination ID",
		...
		"conversion.edit": "(NEED FRENCH)Edit Conversion",
		"conversion.create.button": "(NEED FRENCH)Create Conversion",
		"conversion.edit.title": "(NEED FRENCH)Edit Conversion",
		"conversion.close": "(NEED FRENCH)Close",
		"conversion.submit": "(NEED FRENCH)Submit",
		"conversion.delete": "(NEED FRENCH)Delete",
		"conversion.create.title": "(NEED FRENCH)Create New Conversion",
		"conversion.submit.new": "(NEED FRENCH)Create Conversion",
		"conversion.failed.to.create.conversion": "(NEED FRENCH)Failed to create Conversion",
		"conversion.failed.to.edit.conversion": "(NEED FRENCH)Failed to edit Conversion",
		"conversion.is.deleted": "(NEED FRENCH)Conversion deleted",
		"conversion.failed.to.delete": "(NEED FRENCH)Failed to delete Conversion",
		"conversion.is.created": "(NEED FRENCH)Conversion created",
		"conversion.failed.to.create": "(NEED FRENCH)Failed to create Conversion",
	...
	"es": {
		...
		"conversions.title.main": "(NEED SPANISH)Conversions",
		"conversion.source" : "(NEED SPANISH)Source ID",
		"conversion.destination": "(NEED SPANISH)Destination ID",
		...
		"conversion.edit": "(NEED SPANISH)Edit Conversion",
		"conversion.create.button": "(NEED SPANISH)Create Conversion",
		"conversion.edit.title": "(NEED SPANISH)Edit Conversion",
		"conversion.close": "(NEED SPANISH)Close",
		"conversion.submit": "(NEED SPANISH)Submit",
		"conversion.delete": "(NEED SPANISH)Delete",
		"conversion.create.title": "(NEED SPANISH)Create New Conversion",
		"conversion.submit.new": "(NEED SPANISH)Create Conversion",
		"conversion.failed.to.create.conversion": "(NEED SPANISH)Failed to create Conversion",
		"conversion.failed.to.edit.conversion": "(NEED SPANISH)Failed to edit Conversion",
		"conversion.is.deleted": "(NEED SPANISH)Conversion deleted",
		"conversion.failed.to.delete": "(NEED SPANISH)Failed to delete Conversion",
		"conversion.is.created": "(NEED SPANISH)Conversion created",
		"conversion.failed.to.create": "(NEED SPANISH)Failed to create Conversion",
