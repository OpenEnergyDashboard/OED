...
const localeData = {
	"en": {
		...
		"csv.download.size.warning.size": "File(s) size will be about (usually within 10% for large exports).",
	...
	"fr": {
		...
		"csv.download.size.warning.size": "(Need French) File(s) size will be about (usually within 10% for large exports).",
	...
	"es": {
		...
		"csv.download.size.warning.size": "(Need Spanish) File(s) size will be about (usually within 10% for large exports).",
