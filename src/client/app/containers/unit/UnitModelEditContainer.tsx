...
import UnitModelEditComponent from '../../components/unit/UnitModalEditComponent';
import { showSuccessNotification, showErrorNotification } from '../../utils/notifications';
import { unitsApi } from '../../utils/api';
import { browserHistory } from '../../utils/history';
import { UnitData, UnitType, DisplayableType, UnitRepresentType } from '../../types/redux/units';
import translate from '../../utils/translate';
export default class UnitModelEditContainer extends React.Component<{}, {}> {
    constructor(props: {}){
        super(props);
    ...
    private submitNewUnit = async () => {
        try {
            ...
            showSuccessNotification(translate('units.successfully.edited.unit'))
            browserHistory.push('/units');
        } catch (error) {
            // need to add message into app/translations/data.js
            showErrorNotification(translate('units.failed.to.edit.unit'));
        }
    };
    public render() {
        return (
            <div>
                <UnitModelEditComponent
                    //TODO: create rest of hanlder functions, bind them, and pass to CreateUnitComponent
                    name= {this.state.name}
                    identifier= {this.state.identifier}
                    unitRepresent= {this.state.unitRepresent}
