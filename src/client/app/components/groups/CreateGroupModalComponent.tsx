	...
	*/
	...
	const handleSubmit = () => {
		...
		if (inputOk) {
			...
			// before building the request; this cast is needed here only because stateWithoutId no
			// longer structurally matches GroupData once id is removed client-side.
			createGroup(submitState as unknown as GroupData)
				.unwrap()
				.then(() => {
