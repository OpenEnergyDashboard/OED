...
export function deleteSubmittedConversion(conversionId: number): t.DeleteSubmittedConversionAction {
	return {type: ActionType.DeleteSubmittedConversion, conversionId}
}
