...
echo "This script should not be run with a different container meaning don't use docker-compose."
...
echo "  database if you already ran this before and need to remove that data. You will likely get "
