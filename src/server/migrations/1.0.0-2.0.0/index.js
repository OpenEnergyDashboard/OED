...
module.exports = {
	...
	up: async db => {
		...
		await db.none(sqlFile('../migrations/1.0.0-2.0.0/sql/weather/create_weather_data_table.sql'));
		await db.none(sqlFile('../migrations/1.0.0-2.0.0/sql/weather/create_weather_location_table.sql'));
	}
};
