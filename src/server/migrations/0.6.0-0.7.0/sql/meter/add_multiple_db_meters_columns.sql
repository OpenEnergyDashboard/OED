...
ALTER TABLE meters
    ...
    ADD COLUMN IF NOT EXISTS reading_duplication INTEGER DEFAULT 1,
    ADD COLUMN IF NOT EXISTS time_sort TEXT DEFAULT 'increasing',
    ADD COLUMN IF NOT EXISTS end_only_time BOOLEAN DEFAULT false,
    ADD COLUMN IF NOT EXISTS reading FLOAT DEFAULT 0.0,
    ADD COLUMN IF NOT EXISTS start_timestamp TIMESTAMP DEFAULT '1970-01-01 00:00:00',
    ADD COLUMN IF NOT EXISTS end_timestamp TIMESTAMP DEFAULT '1970-01-01 00:00:00'
    ;
