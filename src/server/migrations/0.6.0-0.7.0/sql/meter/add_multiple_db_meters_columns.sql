...
ALTER TABLE meters
    ...
    ADD COLUMN IF NOT EXISTS start_timestamp TIMESTAMP DEFAULT '01-01-01 00:00:00',
    ADD COLUMN IF NOT EXISTS end_timestamp TIMESTAMP DEFAULT '01-01-01 00:00:00'
    ;
