...
mocha.describe('meters API', () => {
	...
	mocha.it('returns all visible meters', async () => {
		...
		'Identified 1', 'notes 1', 35.0, true, true, '01:01:25', '00:00:00', '05:00:00','00:00:00', 25.5, 
		...
		'Identified 2' ,'notes 2', 35.0, true, true, '01:01:25' , '00:00:00', '05:00:00', '00:00:00', 25.5,
		'0001-01-01 23:59:59', '2020-07-02 01:00:10').insert(conn);
		await new Meter(undefined, 'Meter 3', '1.1.1.1', true, true, Meter.type.MAMAC, 'TZ3', gps,
		'Identified 3', 'notes 3', 35.0, true, true, '01:01:25' , '00:00:00', '05:00:00', '00:00:00', 25.5, 
		'0001-01-01 23:59:59', '2020-07-02 01:00:10').insert(conn);
		await new Meter(undefined, 'Not Visible', '1.1.1.1', true, false, Meter.type.MAMAC, 'TZ4', gps, 
		'Identified 4' ,'notes 4', 35.0, true, true, '01:01:25' , '00:00:00', '05:00:00', '00:00:00', 25.5, 
		'0001-01-01 23:59:59', '2020-07-02 01:00:10').insert(conn);
