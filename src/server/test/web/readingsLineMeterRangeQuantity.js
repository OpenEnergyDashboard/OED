			...
			mocha.describe("for line charts", () => {
				mocha.describe("for range (min/max)", () => {
					mocha.describe("for quantity meters", () => {
						...
						// Add LR3 here
						mocha.it(
							"LR3: range should have daily points for middle readings of 15 minute for a 61 day period and quantity units with kWh as kWh",
							async () => {
						...
						mocha.it(
							...
							async () => {
								// u10: kg, u11: metric ton, u12: kg CO₂
								...
								// c11, c12, c13 - chained: Electric_Utility → kg CO₂ → kg → metric ton
								...
								const expected = await parseExpectedCsv(
									"src/server/test/web/readingsData/expected_line_range_ri_15_mu_kWh_gu_MTonCO2_st_-inf_et_inf.csv",
								);
