...
const csvDataReal = `
'2018-04-26 16:04:59',x,x,x,0,0,0,35304.57,0.42,0.49,0.65,0.65,491.97,284.75,0.75,0,0,0.42,1.00,1.00,0.65,489.86,491.38,494.65,284.17,284.90,285.20,0,0,2.25,60.01,47968.77,30384.27,0,0,0.64,0,0,0.49,0.46,0.57,0.73,20.51,8.93
...
mocha.describe('loadLogfileToReadings', async () => {
	...
	mocha.it('adds the right number and type of meters', async () => {
		csvDataAdd2Meters = '1970-01-01 00:00:00,x,x,x,10,10\n1970-01-02 00:00:00,x,x,x,20,20';
	...
	mocha.it('adds readings that overlap', async () => {
		csvDataAdd2Meters = '1970-01-01 00:00:00,x,x,x,10\n1970-01-01 00:30:00,x,x,x,20';
		await loadLogfileToReadings('000', '0.0.0.0', csvDataAdd2Meters, conn);
	...
	mocha.it('does not modify accepted data when multiple data points exist at one time', async () => {
		csvDataAddDuplicate = '1970-01-01 00:00:00,x,x,x,10\n1970-01-01 00:00:00,x,x,x,20';
