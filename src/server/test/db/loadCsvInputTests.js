...
mocha.describe('PIPELINE: Load data from csv file', () => {
	...
	mocha.it('as array', async () => {
		...
		await loadCsvInput(testFilePath, arrayMeter.id, mapRowsToModel, false, false, false, '0:00:00', '0:00:00',
			0, 0, 1, 'increasing', false, undefined, conn);
	...
	mocha.it('as stream', async () => {
		...
		await loadCsvInput(testFilePath, streamMeter.id, mapRowsToModel, true, false, false, '0:00:00', '0:00:00',
			0, 0, 1, 'increasing', false, undefined,  conn);
