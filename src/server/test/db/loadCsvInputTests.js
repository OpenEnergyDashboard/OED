...
mocha.describe('PIPELINE: Load data from csv file', () => {
	...
	mocha.it('as array', async () => {
		...
		await loadCsvInput(testFilePath, arrayMeter.id, mapRowsToModel, false, 'increasing', 1, false, false, '0:00:00', '0:00:00',
	...
	mocha.it('as stream', async () => {
		...
		await loadCsvInput(testFilePath, streamMeter.id, mapRowsToModel, true, 'increasing', 1, false, false, '0:00:00', '0:00:00',
			0, 0, false, false, undefined,  conn);
