...
async function createCikArray(graph, conn) {
	...
	// WARNING: Currently this function is used to simulate deletion of conversions in conversions.js, if at some point we do change the database when the function is called
