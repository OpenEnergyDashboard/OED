...
-- Gets number of meter readings by id and date range. When requireDisplayable is true,
-- readings for a meter that is not displayable are excluded, the same as for a meter id
-- that does not exist.
SELECT
  COUNT(*)
FROM readings
