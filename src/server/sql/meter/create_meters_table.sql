...
CREATE TABLE IF NOT EXISTS meters (
    ...
    min_val BIGINT NOT NULL DEFAULT -9007199254740991 CHECK (min_val::INTEGER >= -9007199254740991),
    max_val BIGINT NOT NULL DEFAULT 9007199254740991 CHECK (max_val::INTEGER <= 9007199254740991),
