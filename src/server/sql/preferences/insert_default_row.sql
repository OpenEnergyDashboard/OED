...
IF NOT EXISTS(SELECT *
	...
	THEN
	INSERT INTO preferences (display_title, default_chart_to_render, default_bar_stacking, default_language, default_timezone, default_warning_file_size, default_file_size_limit, default_area_normalization) 
	VALUES ('', 'line', FALSE, 'en', NULL, 5, 25, FALSE);
