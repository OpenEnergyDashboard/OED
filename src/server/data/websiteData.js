...
async function insertWebsiteData() {
    ...
    const meters = [
        ...
        ['Dining Hall Electric', 'Electric_Utility', 'kWh', true, undefined, undefined, 'data/webData/DiningHallElectric.csv', false, 10012],
        ...
        ['Theater Electric', 'Electric_Utility', 'kWh', true, undefined, undefined, 'data/webData/TheaterElectric.csv', false, 10016],
        ...
        ['Library Electric', 'Electric_Utility', 'kWh', true, undefined, undefined, 'data/webData/LibraryElectric.csv', false, 10020],
        ...
        ['Great Dorm 1st Floor Electric', 'Electric_Solar', 'kWh', true, undefined, undefined, 'data/webData/GreatDorm1stFloorElectric.csv', false, 10022],
        ['Great Dorm 2nd Floor Electric', 'Electric_Solar', 'kWh', true, undefined, undefined, 'data/webData/GreatDorm2ndFloorElectric.csv', false, 10023],
    ...
    const groups = [
        ...
        ['Great Dorm Electric', 'kWh', true, undefined, 'Great Dorm 1st & 2nd Electric', ['Great Dorm 1st Floor Electric', 'Great Dorm 2nd Floor Electric'], [], 10018],
